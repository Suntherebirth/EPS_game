...
export const OFFENSE_CORE_PACK: ScenarioPack = {
  ...
  nodes: {
    ...
    'strikeout.catcher.check': {
      ...
      outcomes: [
        { id: 'clearDrop', label: '명백하게 완전히 뒤로 빠뜨림', weight: RUNNING_CHANCES.droppedThirdStrikeClear, transition: { to: 'strikeout.clearDrop.decide', effects: [{ type: 'record', message: '낫아웃, 포수가 공을 완전히 빠뜨림', showInCompletion: false }, { type: 'announce', title: '포수가 공을 뒤로 빠뜨렸습니다!', detail: '완전히 뒤로 빠졌습니다. 열심히 뛴다면 확실히 살 수 있습니다.', tone: 'positive' }] } },
    ...
    'fly.outfield.drop': {
      ...
      effects: [{ type: 'applyHit', batterTo: 1, creditHit: true }, { type: 'setPlayerBase', value: 1 }, { type: 'record', message: '외야수 포구 실책 1루타' }, { type: 'announce', title: '외야수가 뜬공을 놓쳤습니다!', detail: '실책으로 타자 주자가 1루에 진출합니다.' }],
    ...
    'fly.infield.drop': {
      ...
      effects: [{ type: 'applyHit', batterTo: 1, creditHit: true }, { type: 'setPlayerBase', value: 1 }, { type: 'record', message: '내야수 포구 실책 1루타' }, { type: 'announce', title: '내야수가 뜬공을 놓쳤습니다!', detail: '실책으로 타자 주자가 1루에 진출합니다.' }],
      transition: { to: 'runner.route' },
    },
    'infieldFly.rule.out': {
