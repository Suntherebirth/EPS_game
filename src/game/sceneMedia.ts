...
const SCENE_BY_ANNOUNCEMENT_TITLE: Record<string, SceneId> = {
  ...
  '외야수가 타구를 완전히 뒤로 빠뜨렸습니다!': 'error-outfield-through-clear',
  '외야수가 타구를 애매하게 뒤로 빠뜨렸습니다!': 'error-outfield-through-ambiguous',
  '외야수 실책이 나왔지만 진루하지 않았습니다.': 'error-outfield-through-clear',
  '후속 타자 타구 외야수 실책이 나왔지만 진루하지 않았습니다.': 'error-outfield-through-clear',

  '포수가 공을 뒤로 빠뜨렸습니다!': 'dropped-third-strike-clear',
  ...
  '명백하게 깊은 외야 플라이, 태그업을 시도합니다.': 'sacrifice-fly-clear',
