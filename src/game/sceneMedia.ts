...
const SCENE_BY_ANNOUNCEMENT_TITLE: Record<string, SceneId> = {
  ...
  '후속 타자 내야 땅볼 아웃': 'ground-first-base-catch',
  '후속타자의 내야 땅볼 아웃!': 'ground-first-base-catch',
  ...
  '2루 진루 실패': 'advance-ambiguous-out',
  '3루 진루 실패': 'advance-ambiguous-out',
  '추가 진루 실패': 'advance-ambiguous-out',
  '2루 도루 실패': 'advance-ambiguous-out',
  '3루 도루 실패': 'advance-ambiguous-out',
  '후속 타자 내야 땅볼 3루 진루 실패': 'advance-ambiguous-out',
  '후속 타자 내야 땅볼 3루 진루 성공!': 'advance-ambiguous-safe',
  ...
  '내야 땅볼 송구 실책 추가 진루 성공!': 'advance-clear',
  '추가 진루 성공!': 'advance-clear',
