export const SCENARIO_TEXT = {
	...
	steal: {
		...
		secondSuccess: { title: '2루 도루 성공!', detail: '2루에 도착했습니다.', detailScene: 'advance-ambiguous-safe' as const, titleImageMode: 'same-as-detail-scene' as const },
		thirdSuccess: { title: '3루 도루 성공!', detail: '3루에 도착했습니다.', detailScene: 'advance-ambiguous-safe' as const, titleImageMode: 'same-as-detail-scene' as const },
