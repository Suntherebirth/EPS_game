export const SCENARIO_TEXT = {
	...
	advanceArrival: '{destination}에 안전하게 도착했습니다.',
	riskyAdvanceSuccess: '위험을 감수하고 {destination} 추가 진루에 성공했습니다.',
	batting: {
		single: { title: '1루타 성공!', detail: '1루에 안전하게 도착했습니다.' },
		double: { title: '2루타 성공!', detail: '2루에 안전하게 도착했습니다.' },
		triple: { title: '3루타 성공!', detail: '3루에 안전하게 도착했습니다.' },
		walk: { title: '볼넷!', detail: '1루에 걸어서 도착했습니다.' },
		hitByPitch: { title: '사구!', detail: '1루에 걸어서 도착했습니다.' },
		homeRun: { title: '홈런!', detail: '타자와 모든 주자가 안전하게 홈에 들어왔습니다.' },
	},
	steal: {
	...
	running: {
		...
		advanceThirdSuccess: { title: '3루 진루 성공!', detail: '위험을 감수하고 3루에 도착했습니다.' },
		...
		defense: {
			droppedThirdStrikeClear: { title: '헛스윙 삼진을 당했지만, 상대 포수가 공을 뒤로 빠뜨렸습니다!', detail: '완전히 뒤로 빠졌습니다. 열심히 뛴다면 확실히 살 수 있습니다.' },
			droppedThirdStrikeAmbiguous: { title: '헛스윙 삼진을 당했지만, 상대 포수가 공을 뒤로 빠뜨렸습니다!', detail: '애매하게 빠졌습니다. 열심히 뛴다면 살 수 있을지도 모릅니다.' },
			droppedThirdStrikeOut: { title: '낫아웃 아웃!', detail: '상대 포수의 1루 송구가 빨라 1루에서 아웃되었습니다.' },
			...
			infieldFlyOut: { title: '내야 뜬공 아웃!', detail: '플레이가 완료되었습니다.' },
			groundOut: { title: '내야 땅볼 아웃!', detail: '플레이가 완료되었습니다.' },
			flyOut: { title: '외야 뜬공 아웃!', detail: '플레이가 완료되었습니다.' },
